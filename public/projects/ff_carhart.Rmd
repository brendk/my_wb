...
```{r load-factors-data, message=FALSE, warning=FALSE}
...
```{r load-stocks-data, message=FALSE, warning=FALSE}
...
```{r r-squared-table, message=FALSE, warning=FALSE}
...
```{r avg-r-squared, message=FALSE, warning=FALSE}
